...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TestCase.is_public'
        db.add_column(u'onlinejudge_testcase', 'is_public',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TestCase.hint'
        db.add_column(u'onlinejudge_testcase', 'hint',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TestCase.is_public'
        db.delete_column(u'onlinejudge_testcase', 'is_public')

        # Deleting field 'TestCase.hint'
        db.delete_column(u'onlinejudge_testcase', 'hint')
    ...
    models = {
        ...
        u'onlinejudge.testcase': {
            ...
            'hint': ('django.db.models.fields.TextField', [], {'default': "''"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
