...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TestCase.type'
        db.add_column(u'onlinejudge_testcase', 'type',
                      self.gf('django.db.models.fields.CharField')(default='IO', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TestCase.type'
        db.delete_column(u'onlinejudge_testcase', 'type')
