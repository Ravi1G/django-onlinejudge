...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'onlinejudge_submission', 'status', self.gf('django.db.models.fields.CharField')(max_length=2))

    def backwards(self, orm):

        # Changing field 'Submission.status'
        db.alter_column(u'onlinejudge_submission', 'status', self.gf('django.db.models.fields.IntegerField')())
