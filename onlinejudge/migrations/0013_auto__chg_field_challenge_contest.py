...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Challenge.contest'
        db.alter_column(u'onlinejudge_challenge', 'contest_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['onlinejudge.Contest']))

    def backwards(self, orm):

        # Changing field 'Challenge.contest'
        db.alter_column(u'onlinejudge_challenge', 'contest_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['onlinejudge.Contest'], null=True))
