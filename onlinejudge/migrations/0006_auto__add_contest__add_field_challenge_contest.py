...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field participants on 'Contest'
        m2m_table_name = db.shorten_name(u'onlinejudge_contest_participants')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('contest', models.ForeignKey(orm[u'onlinejudge.contest'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['contest_id', 'user_id'])

        # Adding field 'Challenge.contest'
        db.add_column(u'onlinejudge_challenge', 'contest',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['onlinejudge.Contest'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field participants on 'Contest'
        db.delete_table(db.shorten_name(u'onlinejudge_contest_participants'))

        # Deleting field 'Challenge.contest'
        db.delete_column(u'onlinejudge_challenge', 'contest_id')
    ...
    models = {
        ...
        u'onlinejudge.challenge': {
            ...
            'contest': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['onlinejudge.Contest']", 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
