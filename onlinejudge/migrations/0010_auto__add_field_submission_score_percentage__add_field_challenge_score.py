...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Submission.score_percentage'
        db.add_column(u'onlinejudge_submission', 'score_percentage',
                      self.gf('django.db.models.fields.IntegerField')(default=-1),
                      keep_default=False)

        # Adding field 'Challenge.score'
        db.add_column(u'onlinejudge_challenge', 'score',
                      self.gf('django.db.models.fields.IntegerField')(default=5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Submission.score_percentage'
        db.delete_column(u'onlinejudge_submission', 'score_percentage')

        # Deleting field 'Challenge.score'
        db.delete_column(u'onlinejudge_challenge', 'score')
