...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TestResult.task_id'
        db.add_column(u'onlinejudge_testresult', 'task_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TestResult.task_id'
        db.delete_column(u'onlinejudge_testresult', 'task_id')
