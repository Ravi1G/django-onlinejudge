...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TestCase.cpu_time_limit'
        db.add_column(u'onlinejudge_testcase', 'cpu_time_limit',
                      self.gf('django.db.models.fields.IntegerField')(default=2000),
                      keep_default=False)

        # Adding field 'TestCase.wallclock_time_limit'
        db.add_column(u'onlinejudge_testcase', 'wallclock_time_limit',
                      self.gf('django.db.models.fields.IntegerField')(default=30000),
                      keep_default=False)

        # Adding field 'TestCase.memory_limit'
        db.add_column(u'onlinejudge_testcase', 'memory_limit',
                      self.gf('django.db.models.fields.IntegerField')(default=8388608),
                      keep_default=False)

        # Adding field 'TestCase.disk_limit'
        db.add_column(u'onlinejudge_testcase', 'disk_limit',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TestCase.cpu_time_limit'
        db.delete_column(u'onlinejudge_testcase', 'cpu_time_limit')

        # Deleting field 'TestCase.wallclock_time_limit'
        db.delete_column(u'onlinejudge_testcase', 'wallclock_time_limit')

        # Deleting field 'TestCase.memory_limit'
        db.delete_column(u'onlinejudge_testcase', 'memory_limit')

        # Deleting field 'TestCase.disk_limit'
        db.delete_column(u'onlinejudge_testcase', 'disk_limit')
